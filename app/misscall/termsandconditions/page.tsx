		...
		<div className="min-h-screen bg-zinc-50 px-6 py-16 text-zinc-950 sm:px-10">
			<main className="mx-auto w-full max-w-3xl rounded-3xl bg-white px-6 py-10 shadow-sm ring-1 ring-zinc-100 sm:px-10 sm:py-12">
				...
				<section className="mt-10 space-y-6 text-base leading-7 text-zinc-600">
					<p>
						These terms and conditions apply to the MissedCall - SMS Auto reply
						app (hereby referred to as &quot;Application&quot;) for mobile devices that
						was created by Sergey Dushevski (hereby referred to as &quot;Service
					...
					<div className="space-y-3">
						...
						<p>These terms and conditions are effective as of 2026-02-14</p>
					</div>
					<div className="space-y-3">
						...
						<p>
							...
							Provider at ericfreemanapps@gmail.com.
						</p>
					</div>
